...
<div class="banner_top">
	<div class="slider">
		<div class="wrapper">
			<div class="agile_banner_text_info overlay">
				<div class="prop">
					<h3 class="editContent"> 
						<span class="editContent">Metal is our 
						</span> Business  
					</h3>
				</div>
			</div>
			...
			<ul class="rslides" id="slider">
				<li>
					<video  autoplay loop id="video-background" muted plays-inline>
					  <source src="images/video/AdobeStock_98710391.mp4">
					</video>
				</li>
				<li><video autoplay loop id="video-background" muted plays-inline>
					  <source src="images/video/AdobeStock_104012547.mp4">
					</video>
				</li>
			</ul>
			<!-- Slideshow 3 Pager -->
